...
return [
     ...
     *
     */
    'tenant_finder' => \App\TenantFinders\SubdomainTenantFinder::class,

    // Solo para desarrollo local (localhost sin subdominio)
    'local_default_domain' => env('TENANT_LOCAL_DOMAIN', null),
