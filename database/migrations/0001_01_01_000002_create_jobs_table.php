...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::connection('landlord')->create('job_batches', function (Blueprint $table) {
    ...
    public function down(): void
    {
        ...
        Schema::connection('landlord')->dropIfExists('job_batches');
        Schema::connection('landlord')->dropIfExists('jobs');
    }
};
